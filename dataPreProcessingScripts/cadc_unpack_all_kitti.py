...
base_dir        = 'C:/AdverseWeatherDataset/CADC/Dataset/cadcd'
...
val_seq_sel     = [[5,6,8,9,10],[1,2,5,6,7],[3,4,5,14,29,30,32,44,48,50,55,56,58,74]]
train_ratio     = 0.80
MIN_NUM_POINTS  = 0
crop_top        = 150
crop_bottom     = 250
...
def create_output_directory(camera):
    home_dir = os.path.join(base_dir,'labeled')
    modes = ['train','val']
    for mode in modes:
